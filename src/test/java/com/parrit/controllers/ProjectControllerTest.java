...
public class ProjectControllerTest {
    ...
    public void deletePairingBoard_removesMatchingPairingBoardFromProject_andReturnsTheUpdatedProject() throws Exception {
        PairingBoard existingPairingBoard = new PairingBoard("Ka-Boom", false, new ArrayList<>());
    ...
    public void deletePairingBoard_movesPeopleFromMatchingPairingBoard_intoFloating() throws Exception {
        ...
        PairingBoard existingPairingBoard = new PairingBoard("Ka-Boom", false, new ArrayList<>(Collections.singletonList(existingPerson)));
        existingPairingBoard.setId(55L);
        ...
        Project expectedUpdatedProject = new Project("Henry", "henrypass", new ArrayList<>(), new ArrayList<>(Collections.singletonList(existingPerson)));
        expectedUpdatedProject.setId(1L);
    ...
    public void movePerson_whenNoPairingBoardMatchesGivenId_returnsError() throws Exception {
        ...
        mockMvc.perform(put("/api/project/1/person/76/position")
                ...
                .andExpect(jsonPath("$.message", equalTo(null)))
                .andExpect(jsonPath("$.fieldErrors.id", equalTo("Keeaa!? That pairing board doesn't seem to exist.")));
        //TODO: Get it to be fieldErrors.pairingBoardId
