...
public class PairingServiceTest {
    ...
    class SavePairing {
        ...
        public void savePairing_createsAPairingHistory_andPersistsIt() {
            ...
            PairingBoard pairingBoard = new PairingBoard("The Pairing Board", false, Set.of(p1, p2), new ArrayList<>());
            pairingBoard.setId(1L);
            Set<PairingBoard> pairingBoards = Set.of(pairingBoard);

            Project project = new Project("One", "onepass", pairingBoards, new HashSet<>());

            pairingService.savePairing(project);

            PairingHistory expectedPairingHistory = new PairingHistory(null, "The Pairing Board", Set.of(p1, p2), null);
        ...
        public void savePairing_createsMultiplePairingHistoriesWithDifferentPairingBoardNames_whenThereAreMoreThanOnePairingBoards() {
            ...
            PairingBoard pairingBoard1 = new PairingBoard("The Pairing Board", false, Set.of(p1, p2), new ArrayList<>());
            pairingBoard1.setId(1L);
            PairingBoard pairingBoard2 = new PairingBoard("The Second Pairing Board", false, Set.of(p3, p4), new ArrayList<>());
            pairingBoard2.setId(2L);

            Set<PairingBoard> pairingBoards = Set.of(pairingBoard1, pairingBoard2);

            Project project = new Project("One", "onepass", pairingBoards, new HashSet<>());

            pairingService.savePairing(project);

            PairingHistory expectedPairingHistory1 = new PairingHistory(null, "The Pairing Board", Set.of(p1, p2), null);
            PairingHistory expectedPairingHistory2 = new PairingHistory(null, "The Second Pairing Board", Set.of(p3, p4), null);
        ...
        public void savePairing_createsMultiplePairingHistoriesWithSamePairingBoardName_whenAPairingBoardHasMoreThanTwoPeople() {
            ...
            PairingBoard pairingBoard = new PairingBoard("The Pairing Board", false, Set.of(p1, p2, p3), new ArrayList<>());
            pairingBoard.setId(1L);
            ...
            PairingHistory expectedPairingHistory = new PairingHistory(null, "The Pairing Board", Set.of(p1, p2, p3), null);
        ...
        public void savePairing_createsAPairingHistory_whenThereIsOnlyOnePersonInAPairingBoard() {
            ...
            PairingBoard pairingBoard = new PairingBoard("The Pairing Board", false, Set.of(p1), new ArrayList<>());
            pairingBoard.setId(1L);
            ...
            PairingHistory expectedPairingHistory = new PairingHistory(null, "The Pairing Board", Set.of(p1), null);
        ...
        public void savePairing_doesNotCreateAPairingHistory_whenThereIsNoOneInAPairingBoard() {
            PairingBoard pairingBoard = new PairingBoard("The Pairing Board", false, emptySet(), new ArrayList<>());
            pairingBoard.setId(1L);
    ...
    public void getSortedPairingHistory_getsThePairingHistoriesForAProject_sortedByMostRecentPairingHistory() {
        Project project = new Project("One", "onepass", new HashSet<>(), new HashSet<>());

        List<PairingArrangement> arrangements = List.of(
                PairingArrangement.builder()
                        .pairingTime(new Timestamp(50))
                        .pairingHistories(Set.of(new PairingHistory(project, "Pairing Board", Set.of(), new Timestamp(10))))
                        .project(project)
                        .build(),
                PairingArrangement.builder()
                        .pairingTime(new Timestamp(10))
                        .pairingHistories(Set.of(new PairingHistory(project, "Pairing Board 2", Set.of(), new Timestamp(50))))
                        .project(project)
                        .build()
        );
