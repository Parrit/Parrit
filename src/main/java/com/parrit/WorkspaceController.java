...
public class WorkspaceController {
    ...
    Workspace retrieve() {
    	...
    	if (workspace == null) {
			...
			+ "<div class=\"draggable drag-drop\">Lance</div>"
			+ "<div class=\"draggable drag-drop\">Liz</div>"
			+ "<div class=\"draggable drag-drop\">Sree</div>"
			+ "<!-- Spaces -->"
			+ "<div class=\"dropzone well\">Design</div>"
			+ "<div class=\"dropzone well\">Product</div>"
