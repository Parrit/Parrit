...
describe("DatabaseHelpers", () => {
  ...
  describe("#postLoginAndRedirect", () => {
    ...
    beforeEach(() => {
      ...
      databaseHelpers.postLoginAndRedirect(
        "Username",
        "Password",
        errorCallbackSpy
      );
  ...
  describe("#postProjectAndDo", () => {
    ...
    beforeEach(() => {
      ...
      databaseHelpers.postProjectAndDo(
        projectName,
        projectPassword,
        successCallbackSpy,
        errorCallbackSpy
  ...
  describe("#resetProjectAndDo", () => {
    ...
    beforeEach(() => {
      ...
      databaseHelpers.resetProjectAndDo(
        projectId,
        successCallbackSpy,
        errorCallbackSpy
      );
  ...
  describe("#postPersonAndDo", () => {
    ...
    beforeEach(() => {
      ...
      databaseHelpers.postPersonAndDo(
        projectId,
        newPersonName,
        successCallbackSpy,
        errorCallbackSpy
    ...
    it("makes an Ajax call to post the new person", () => {
      expect(Axios.post.calls.count()).toBe(1);
      expect(Axios.post).toHaveBeenCalledWith("/api/project/87/person", {
        name: newPersonName,
      });
    });
  ...
  describe("#putPersonPositionAndDo", () => {
    ...
    beforeEach(() => {
      ...
      databaseHelpers.putPersonPositionAndDo(
        projectId,
        personId,
        newPosition,
        successCallbackSpy,
    ...
    it("makes an Ajax call to put the new position of the person", () => {
      ...
      expect(Axios.put).toHaveBeenCalledWith(
        "/api/project/87/person/55/position",
        newPosition
      );
    });
  ...
  describe("#deletePersonAndDo", () => {
    ...
    beforeEach(() => {
      ...
      databaseHelpers.deletePersonAndDo(
        1,
        44,
        successCallbackSpy,
        errorCallbackSpy
  ...
  describe("#postPairingAndDo", () => {
    ...
    beforeEach(() => {
      ...
      databaseHelpers.postPairingBoardAndDo(
        projectId,
        newPairingBoardName,
        successCallbackSpy,
        errorCallbackSpy
    ...
    it("makes an Ajax call to post the new pairing board", () => {
      expect(Axios.post.calls.count()).toBe(1);
      expect(Axios.post).toHaveBeenCalledWith("/api/project/87/pairingBoard", {
        name: newPairingBoardName,
      });
    });
  ...
  describe("#putPairingBoardAndDo", () => {
    ...
    beforeEach(() => {
      ...
      databaseHelpers.putPairingBoardAndDo(
        1,
        2,
        newPairingBoardName,
        successCallbackSpy,
    ...
    it("makes an Ajax call to put the pairing board", () => {
      expect(Axios.put.calls.count()).toBe(1);
      expect(Axios.put).toHaveBeenCalledWith("/api/project/1/pairingBoard/2", {
        name: newPairingBoardName,
      });
    });
  ...
  describe("#deletePairingBoardAndDo", () => {
    ...
    beforeEach(() => {
      ...
      databaseHelpers.deletePairingBoardAndDo(
        1,
        2,
        successCallbackSpy,
        errorCallbackSpy
  ...
  describe("#postRoleAndDo", () => {
    ...
    it("makes an Ajax call to post the new role", () => {
      ...
      expect(
        Axios.post
      ).toHaveBeenCalledWith("/api/project/87/pairingBoard/870/role", {
        name: newRoleName,
      });
    });
  ...
  describe("#putRolePositionAndDo", () => {
    ...
    beforeEach(() => {
      ...
      databaseHelpers.putRolePositionAndDo(
        projectId,
        pairingBoardId,
        roleId,
        newPosition,
    ...
    it("makes an Ajax call to put the new position of the role", () => {
      expect(Axios.put.calls.count()).toBe(1);
      expect(Axios.put).toHaveBeenCalledWith(
        "/api/project/87/pairingBoard/55/role/66/position",
        newPosition
      );
    });
  ...
  describe("#deleteRoleAndDo", () => {
    ...
    beforeEach(() => {
      ...
      databaseHelpers.deleteRoleAndDo(
        projectId,
        pairingBoardId,
        roleId,
        successCallbackSpy,
    ...
    it("makes an Ajax call to delete the role", () => {
      expect(Axios.delete.calls.count()).toBe(1);
      expect(Axios.delete).toHaveBeenCalledWith(
        "/api/project/87/pairingBoard/870/role/8700"
      );
    });
  ...
  describe("#getRecommendedPairingAndDo", () => {
    ...
    it("makes an Ajax call to get recommended pairing with the projectId", () => {
      ...
      expect(Axios.get).toHaveBeenCalledWith(
        "/api/project/42/pairing/recommend"
      );
    });
